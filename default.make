...
CFLAGS := $(CFLAGS) $(GL_INCLUDE) $(shell pkg-config --cflags freetype2) $(shell pkg-config --cflags glfw3) $(shell pkg-config --cflags $(ODE))
...
#LDFLAGS += $(shell pkg-config --static --libs $(ODE))
